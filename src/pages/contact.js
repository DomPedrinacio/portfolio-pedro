            ...
            <div className="container">
                ...
                <div className="contact-socials">
                    ...
                    <a href="https://github.com/DomPedrinacio"
                        ...
                        <span className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="github" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.linkedin.com/in/pedro-augusto-576470236/"
                        ...
                        rel="noreferrer"
                        className="social-card">
                        <span className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="linkedin" viewBox="0 0 16 16">
                    ...
                    <a href="https://wa.me/5531984400167"
                        ...
                        rel="noreferrer"
                        className="social-card">
                        <span className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="whatsapp" viewBox="0 0 16 16">
                    ...
                    <a href="https://www.instagram.com/dompedrinacio?igsh=MTJ4am8waXB1MHcw&utm_source=qr"
                        ...
                        rel="noreferrer"
                        className="social-card">
                        <span className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="instagram" viewBox="0 0 16 16">
                    ...
                    <a href="mailto:pedroafmcampos@gmail.com"
                        className="social-card">
                        <span className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="email" viewBox="0 0 16 16">
